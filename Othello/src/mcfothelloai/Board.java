...
public class Board {
	 ...
	 *
	 * @param player
	 *            -- player for which moves are generated
	...
	public int moveVal(int row, int column) {
		int value[][] = { { 100, 1, 20, 20, 20, 20, 1, 100 }, { 1, 1, 5, 5, 5, 5, 1, 1 }, { 20, 5, 2, 2, 2, 2, 5, 20 },
				{ 20, 5, 2, 0, 0, 2, 5, 20 }, { 20, 5, 2, 0, 0, 2, 5, 20 }, { 20, 5, 2, 2, 2, 2, 5, 20 },
				{ 1, 1, 5, 5, 5, 5, 1, 1 }, { 100, 1, 20, 20, 20, 20, 1, 100 } };
