...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        //McfOthelloAI AI2 = new McfOthelloAI(color*-1);
        ...
        while(!board.gameOver()){
            ...
            ArrayList<Move> test = board.generateMoves(turn);
            if (test.isEmpty()) {
                System.out.println("C test is empty");
            } else {
                System.out.println("C " + Arrays.toString(test.toArray()));
            }
            
            if(turn == AI.color){
                Move nextMove = AI.findMove(board);
                ...
                Move nextMove = AI2.findMove(board);
                if(nextMove.r<0 || nextMove.c<0){
                    System.out.println(AI2.cColor + "  ");
                }else {
                    System.out.println(AI2.cColor + " " + nextMove.getC() + " " + nextMove.getR());
                    board.applyMove(turn, nextMove);
                }
            }
            turn = turn*-1;
